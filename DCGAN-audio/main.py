...
flags.DEFINE_integer("run_g", 1, "Number of times to update the generator per discriminator update [2]")
...
flags.DEFINE_boolean("use_fourier", False, "Whether the discriminator will use Fourier information")
